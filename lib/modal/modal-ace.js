...
(function ($) {
    ...
    $.require(modal.scriptPath + "modal-ace.css");
    var preferences = "preferences.ace-settings",

    defaultSettings = {
        "theme": "clouds", "fontSize": 12, "printMargin": 80, "showFoldWidgets": true,
        "highlightActiveLine": true, "showInvisibles": false, "persistentHorizScroll": false, "animateScrolling": false,
        "softWrap": false, "showGutter": true, "showPrintMargin": true, "softTab": true,
        "tabSize": 4, "highlightSelectedWord": true, "enableBehaviours": true, "fadeFoldWidgets": true,
        "customFileRules": {},"customThemes": []
    },

    defaultSupportedThemes = [
        "clouds_midnight", "clouds", "cobalt", "crimson_editor",
        "dawn", "dreamweaver", "idle_fingers", "kr_theme",
        "merbivore_soft", "merbivore", "mono_industrial", "monokai",
        "pastel_on_dark", "solarized_dark", "solarized_light", "textmate",
        "tomorrow_night_blue", "tomorrow_night_bright", "tomorrow_night_eighties", "tomorrow_night",
        "tomorrow", "twilight", "vibrant_ink"
    ],
    ...
    defaultSupportedLanguages = {
        ...
        "php": "php", "json": "json|ace-settings", "java": "java", "lua": "lua",
