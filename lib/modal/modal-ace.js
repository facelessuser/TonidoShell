...
(function ($) {
    ...
    defaultSupportedLanguages = {
        ...
        "liquid": "liquid",
        "lua": "lua",
        // "luahtml": null, //Not really sure what this is vs luapage examples from ace don't show access to this
        "luapage": "lp",
    ...
    function aceEdit(text, options, fn) {
        ...
        modal(
            id,
            {
                ...
                'text'          : (
                    '<a href="javascript:void(0)" class="ace_modal_settings_button" id="aceSettings' + id + '"></a>'
                ),
                'body'          : body,
                'fnYes'         : callback,
                'fnNo'          : function(e) {
                            ...
                            $(doc).easyJS(overlay).fade(
                                {
                                    ...
                                    'fn': function () {
                                        ...
                                        $("#aceSettings" + id).attr(
                                            {
                                                "className": "ace_modal_settings_button",
                                                "disabled" : false
                                            }
                                        );
                                    }
                ...
                $(doc).query("#aceSettingsOverlay" + id).fade(
                    {
                        ...
                        'fn' : function () {
                            ...
                            $("#aceSettings" + id).attr(
                                {
                                    "className": "ace_modal_settings_button ace_modal_settings_button_selected",
                                    "disabled" : false
                                }
                            );
                        }
